//original v6.6.0 beautified/prettified by https://www.prettifyjs.net/
...
}(this, (function (t)
{
		...
		function h(e)
		{
			...
			function U(t)
			{
				for (const n of t.changedTouches || [t])
					for (const t of D) t.identifier === n.identifier && (t.cur = Un(n, _));
				if (z && !y && !v && 1 === D.length)
				{
					const t = D[0];
	...
	class Fa
	{
		...
		update()
		{
			...
			for (let o, a, u = 0; u < this._ids.length; u++)
			{
				...
				l = n[l];
				let g, y = l;
				for (; g = e[y], !Ia(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]);)
					if (y = g, y === l)
					{
						y = -1;
						break
	...
	function gh(t)
	{
		...
		return E.stream = function (t)
			...
			{
				return arguments.length ? (T = null == t ? (A = r = i = o = null, fl) : Is(A = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == A ? null : [
					[A, r],
					[i, o]
				]
			}, E.scale = function (t)
	...
	}, t.geoIdentity = function ()
	{
		...
		{
			return arguments.length ? (v = null == t ? (d = e = r = i = null, fl) : Is(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [
				[d, e],
				[r, i]
			]
		}, b.scale = function (t)
	...
	}, t.sort = k, t.stack = function ()
	{
		...
		function i(i)
		{
			var o, a, u = Array.from(t.apply(this, arguments), Gm),
				c = u.length,
				f = -1;
			for (const t of i)
	...
	}, t.zoom = function ()
	{
		...
		function S(e, ...i)
		{
			if (r.apply(this, arguments))
			{
				...
				for (ex(e), a = 0; a < s; ++a) c = [c = Un(u = f[a], this), this.__zoom.invert(c), u.identifier], l.touch0 ? l.touch1 || l.touch0[2] === c[2] || (l.touch1 = c, l.taps = 0) : (l.touch0 = c, o = !0, l.taps = 1 + !!t);
		...
		function E(t, ...n)
		{
			if (this.__zooming)
			{
				var e, r, i, a, u = x(this, n).event(t),
					c = t.changedTouches,
					s = c.length;
				for (rx(t), e = 0; e < s; ++e) i = Un(r = c[e], this), u.touch0 && u.touch0[2] === r.identifier ? u.touch0[0] = i : u.touch1 && u.touch1[2] === r.identifier && (u.touch1[0] = i);
		...
		function k(t, ...r)
		{
			if (this.__zooming)
			{
				...
				else if (a.end(), 2 === a.taps && (o = Un(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < g))
				{
		...
		{
			return arguments.length ? (i = "function" == typeof t ? t : Km([
				[+t[0][0], +t[0][1]],
				[+t[1][0], +t[1][1]]
			]), y) : i
